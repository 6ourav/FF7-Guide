...
<body>
    ...
    <?php
        if ($_SERVER["REQUEST_METHOD"] == "GET") {
            ...
            if ($q1a == 'n') {
                echo "<img src=images/rs.jpg alt=h height=80px>";
                echo "<p>Reinforced Staff</p>";
            } else if ($q2a == 'y') {
                echo "<img src=images/bs.jpg alt=nb height=80px>";
                echo "<p>Bladed Staff</p>";
            } else if ($q3a == 'y') {
                echo "<img src=images/sis.jpg alt=nb height=80px>";
                echo "<p>Silver Staff</p>";
            } else if ($q8a == 'y') {
                echo "<img src=images/as.jpg alt=bs height=80px>";
                echo "<p>Arcane Scepter</p>";
            } else {
                echo "<img src=images/mr.jpg alt=ts height=80px>";
                echo "<p>Mythril Rod</p>";
            }
            ...
            if ($q4a == 'n') {
                if ($q7a == 'bh') {
                    echo "<img src=images/heal.jpg alt=g height=80px>";
                    echo "<p>Healing Carcanet</p>";
                } else {
                    echo "<img src=images/plat.jpg alt=g height=80px>";
                    echo "<p>Platinum Earrings</p>";
                }
            } else {
                echo "<img src=images/spec.jpg alt=cb height=80px>";
                echo "<p>Spectral Cogwheel</p>";
            }
